...
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports {avr}]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports {hc}]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {acr}]
